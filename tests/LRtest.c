...
"		-h	print this message and exit.\n\n", argv[0]);
	...
	pSuite = CU_add_suite("LR_test_suite", init_suite, clean_suite);
	if (pSuite == NULL) {
	...
	if ((NULL == CU_add_test(pSuite,"new - int", test_new_int))
	||  (NULL == CU_add_test(pSuite,"new - float", test_new_float))
	||  (NULL == CU_add_test(pSuite,"new - long", test_new_long))
	||  (NULL == CU_add_test(pSuite,"new - double", test_new_double))
	||  (NULL == CU_add_test(pSuite,"set - int", test_set_int))
	||  (NULL == CU_add_test(pSuite,"set - float", test_set_float))
	||  (NULL == CU_add_test(pSuite,"set - long", test_set_long))
	||  (NULL == CU_add_test(pSuite,"set - double", test_set_double))
	||  (NULL == CU_add_test(pSuite,"set_all - int", test_set_all_int))
	||  (NULL == CU_add_test(pSuite,"set_all - float", test_set_all_float))
	||  (NULL == CU_add_test(pSuite,"set_all - long", test_set_all_long))
	||  (NULL == CU_add_test(pSuite,"set_all - double",test_set_all_double))
	||  (NULL == CU_add_test(pSuite,"set_all2 - int", test_set_all2_int))
	||  (NULL == CU_add_test(pSuite,"set_all2 - float", test_set_all2_float))
	||  (NULL == CU_add_test(pSuite,"set_all2 - long", test_set_all2_long))
	||  (NULL == CU_add_test(pSuite,"set_all2 - double",test_set_all2_double))
	) {
